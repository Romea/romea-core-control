...
FollowTrajectoryPredictiveSliding(const double & whee_base,
...
//-----------------------------------------------------------------------------
double FollowTrajectoryPredictiveSliding::computeFrontSteeringAngle_(const double& lateral_deviation,
                                                                     const double& course_deviation,
                                                                     const double& curvature,
                                                                     const double& future_curvature,
                                                                     const double& front_steering_angle,
                                                                     ...
                                                                     const double& future_desired_lateral_deviation)
{
  ...
  double Vcomm = (wheelbase_/cos(rear_sliding_angle+DeltaM_ar)) *
      (v3*( (std::cos(v1))*(std::cos(v1))*(std::cos(v1)) )/(v2*v2) )+ std::tan(rear_sliding_angle+DeltaM_ar);

  double delta_ecart = std::atan(Vcomm / (1+Ucomm*Vcomm+(Ucomm*Ucomm)) ) + front_sliding_angle;
...
//------------------------------------------------------------------------------
std::vector<double> FollowTrajectoryPredictiveSliding::reference_(const double& CommFutur,
                                                                  const double& alpha,
...
//------------------------------------------------------------------------------
double FollowTrajectoryPredictiveSliding::computeRearSteeringAngle_(const double& lateral_deviation,
                                                                    const double& course_deviation,
                                                                    const double& curvature,
                                                                    const double& rear_sliding_angle)
{
